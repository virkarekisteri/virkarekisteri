...
)
{
    ...
    LogChange("StartDate", existingPositionEmployee.StartDate.ToString("yyyy-MM-dd"), updateDto.StartDate?.ToString("yyyy-MM-dd"));
    LogChange("EndingDate", existingPositionEmployee.EndingDate?.ToString("yyyy-MM-dd"), updateDto.EndingDate?.ToString("yyyy-MM-dd"));
